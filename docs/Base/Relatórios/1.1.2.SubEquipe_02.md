...
| :--- | :--- |
| **Lorena Ribeiro Martins** | Elaboração da Rich Picture, estruturação hierárquica do fluxo de Busca. |
| **Pedro Augusto Ribeiro Faitarone Bessa** | Elaboração do SIG de acordo com o NFR Framework |
...
A entrega do FOCO 02 consistiu na aplicação do Processo de Engenharia Reversa no Informa.BR, com foco no fluxo de busca, e na elaboração da representação visual do fluxo utilizando modelagem BPMN.

### Participantes no Foco_02

| Nome do Membro | Contribuição |
| :--- | :--- |
| **Fábio Alessandro Santos Vieira** | Execução do processo de Engenharia Reversa (levantamento de elementos gráficos, transições de estado, regras de negócio e documentação padronizada do fluxo de busca no portal) e elaboração e desenho da Modelagem BPMN no Figma |
